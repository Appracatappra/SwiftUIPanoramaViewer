...
public struct PanoramaViewer: UIViewRepresentable {
    ...
    public init(image: Binding<UIImage?>, panoramaType: CTPanoramaType, controlMethod: CTPanoramaControlMethod, rotationHandler: CTPanoramaView.CTRotationHandler? = nil, cameraMoved: CTPanoramaView.CTCameraMovedHandler? = nil) {
        self._image = image
